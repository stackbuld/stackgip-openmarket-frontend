export const environment = {
  production: false,
  identityApi:  process.env.identityApi?? 'https://dev-identity.renamarkets.com/api/v1/',
  ecommerceApi: process.env.ecommerceApi?? 'https://dev-ecommerce.renamarkets.com/api/v1/',
  storeApi: process.env.storeApi?? 'https://dev-ecommerce.renamarkets.com/api/',
  paystackPublicKey: process.env.paystackPublicKey ?? 'pk_test_8e75de0f0e2bba17ee0b37ed227e176b92b52d0b',
  notificationApi: process.env.notificationApi ?? 'https://dev-notification.renamarkets.com/',
  ...
  sellerStorefrontApi: process.env.sellerStorefrontApi?? 'https://dev-identity.renamarkets.com/api/v1/sellers/',
  walletApi: process.env.walletApi?? 'https://dev-wallet.renamarkets.com/api/v1/',
  algolia: {
