...
export class OrderManagementComponent implements OnInit {
  ...
  getDashbardOverview = () => {
    ...
    this.orderService.getOrderDashboardOverview(this.sellerId).subscribe((res) => {
  ...
  clear = () => {
    ...
    let selectElement = document.getElementById('filterSelect') as HTMLSelectElement;
    searchInput.value = '';
  ...
  fetchAllOrders = (pageNumber:any) => {
    ...
    this.orderService.fetchAllOrders(
      pageNumber, this.maximumItem, this.sellerId, this.buyerId,
      this.paymentReferenceId, this.type, this.startDate, this.endDate,
      this.dateType, this.orderStatus, this.deliveryStatus, this.paymentStatus, this.search
    ).subscribe((res) => {
