...
@Component({
  ...
  styleUrls: ['../wallet.component.scss', './wallet-withdraw.component.scss', '../../css/spinner.css']
})
...
loading: boolean;
  ...
  changeBank(newBankCode: string) {
    this.bankDetailsForm.patchValue({
      ...
      bankName: this.bankLists.find(data => data?.code?.toString() === newBankCode.toString())?.name,
      accountName: ""
    })
  }
    ...
    this.bankDetailsForm.patchValue({
      ...
      bankName: this.bankLists.find(data => data.code.toString() === details.bankCode.toString()).name,
